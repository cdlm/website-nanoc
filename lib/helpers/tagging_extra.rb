...
module TaggingExtra
  ...
  # Returns all the tags present in a collection of items.  The tags are only
  # present once in the returned value.  When called whithout parameters, all
  # the site items are considered.
  ...
  # counts tags in all the site items.
  ...
  # classes of rank.  The rank 0 corresponds to the most frequent tags. The
  # rank 'n-1' to the least frequents.
